            ...
            <footer className="bg-green-600 border border-gray-600 text-center text-white font-medium p-6">
                <div className="flex flex-wrap justify-center gap-24">
                    <div className="text-left leading-9">
                        <h4 className="font-semibold leading-9 text-2xl text-gray-50 text underline mb-3  decoration-lime-200 tracking-wide">Sobre a Working Scale</h4>
                    ...
                    <div className="text-left leading-9">
                        <h4 className="font-semibold leading-9 text-2xl text-gray-50 underline mb-3  decoration-lime-200 tracking-wide">Institucional</h4>
                    ...
                    <div className="text-left leading-9">
                        <h4 className="font-semibold leading-9 text-2xl text-gray-50 underline mb-3 decoration-lime-200 tracking-wide">Conteúdos</h4>
                    ...
                    <div className="text-left">
                        <h4 className="font-semibold leading-9 text-2xl text-gray-50 underline mb-3 decoration-lime-200 tracking-wide"> Siga-nos! </h4>
                ...
                <div className="flex flex-col justify-items-center items-center mt-5">
                        <p className="font-semibold leading-9 text-2xl text-gray-50 underline mb-3 decoration-lime-200 tracking-wide"> Contato </p>
