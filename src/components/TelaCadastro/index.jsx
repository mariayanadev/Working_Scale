        ...
        <>
            <div className="w-screen h-screen flex justify-center items-center">
                <div
                    ...
                    className="flex flex-col w-[500px] h-fit pb-6 bg-[#bbedca] rounded-lg overflow-hidden shadow-lg shadow-gray-600 "
                >
                    <div
                        id="headerCadastro"
                    ...
                    <form method="post" action="#">
                        ...
                        <div id="botoes" className="mt-4 flex flex-row ml-4 gap-1">
                            <button
                                name="submit"
